...
// +----------------------------------------------------------------------+
//
// $Id: TimeZone.php,v 1.1 2005/06/19 05:21:33 bitweaver Exp $
//
// Date_TimeZone Class
//
/**
...
if(isset($_DATE_TIMEZONE_DEFAULT)
    && Date_TimeZone::is_validID($_DATE_TIMEZONE_DEFAULT)
) {
    Date_TimeZone::setDefault($_DATE_TIMEZONE_DEFAULT);
} elseif (getenv('PHP_TZ') && Date_TimeZone::is_validID(getenv('PHP_TZ'))) {
    Date_TimeZone::setDefault(getenv('PHP_TZ'));
} elseif (getenv('TZ') && Date_TimeZone::is_validID(getenv('TZ'))) {
    Date_TimeZone::setDefault(getenv('TZ'));
} elseif (Date_TimeZone::is_validID(date('T'))) {
