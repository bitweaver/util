...
/* $Id: phplot.php,v 1.1.1.1.2.1 2005/12/25 21:30:01 squareing Exp $ */
...
//Colors and styles       (all colors can be array (R,G,B) or named color)
    ...
    var $data_colors = array('blue','green','yellow','orange','red','purple','navy','SlateBlue','DarkGreen','tan','maroon','magenta','azure1','aquamarine1');
    var $error_bar_colors = array('blue','green','yellow','orange','red','purple','navy','SlateBlue','DarkGreen','tan','maroon','magenta','azure1','aquamarine1');
    var $data_border_colors = array('gray');
